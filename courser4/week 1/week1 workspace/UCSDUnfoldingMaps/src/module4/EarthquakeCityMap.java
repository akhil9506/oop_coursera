	...
	private void printQuakes() 
	{
		...
		for(Marker cm:countryMarkers) {
			...
			for(Marker c:quakeMarkers) {
				if(((EarthquakeMarker) c).isOnLand()) {
					if(((String)cm.getProperty("name")).equals(((LandQuakeMarker)c).getCountry())) {
						counter++;
					}}
		...
		System.out.println("OceanQuakes: "+i);
