...
public class CityMarker extends CommonMarker {
	 ...
	 */
	public void ifclick(PGraphics pg, float x, float y) {
		pg.fill(255,250,240);
		pg.rect(x-10,y-20,200,15);
		pg.fill(0,0,0);
		pg.text(getLocation().toString(), x-2, y-9);
	}
	...
	public void click(PGraphics pg,float x,float y) {
		pg.rect(x,y,15,15);
	}
